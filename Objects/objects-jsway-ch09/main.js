...
// Write a program that creates bank accounts
...
BankAccounts.push(new BankAccount("Alex"));
BankAccounts.push(new BankAccount("Brad"));
BankAccounts.push(new BankAccount("Georges"));
